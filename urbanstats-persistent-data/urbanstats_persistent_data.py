...
def shorten_request():
    ...
    if 'full_text' in flask.request.form:
        ...
        json_response = dict(shortened=shortened)
...
def lengthen_request():
    ...
    if 'shortened' in form:
        ...
        json_response = dict(full_text=full_text[0])
        return flask.jsonify(json_response)
...
def table():
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS ShortenedData
