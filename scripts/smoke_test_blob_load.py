...
Usage:
  python scripts/smoke_test_blob_load.py --base-url http://localhost:5000 --shard-path /shape/00/00/shard_0.gz --longname "California, USA"
  python scripts/smoke_test_blob_load.py --base-url http://localhost:5000 --shard-path /data/00/00/shard_0.gz --longname "California, USA"
