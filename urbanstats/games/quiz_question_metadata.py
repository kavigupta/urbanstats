...
HEALTH_IMHE = QuizQuestionCollection("Health IMHE", difficulty_multiplier=1.5, weight_entire_collection=2)
...
COMMUTE_TIME = QuizQuestionCollection("Commute Time", difficulty_multiplier=3, weight_entire_collection=2)
