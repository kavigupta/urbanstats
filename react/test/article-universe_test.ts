...
test('article-universe-selector-test-california', async (t) => {
    ...
    await t.expect(getLocation())
        .eql(`${TARGET}/article.html?longname=San+Marino+city%2C+California%2C+USA&s=4YErw5vV5ZfzEX&universe=California%2C+USA`)
})
...
test('article-universe-selector-test-india', async (t) => {
    ...
    await t.expect(getLocation())
        .eql(`${TARGET}/article.html?longname=Delhi+%5BNew+Delhi%5D+Urban+Center%2C+India&s=4YErw5vV5ZfzEX&universe=India`)
    await screencap(t)
})
...
test('article-universe-right-arrow', async (t) => {
    ...
    await t.expect(getLocation())
        .eql(`${TARGET}/article.html?longname=Camp+Pendleton+South+CDP%2C+California%2C+USA&universe=California%2C+USA&s=4YErw5vV5ZfzEX`)
})
...
test('article-universe-ordinal', async (t) => {
    ...
    // select all and delete
        ...
        .pressKey('enter')
    await t.expect(getLocation())
        .eql(`${TARGET}/article.html?longname=San+Jose+city%2C+California%2C+USA&universe=California%2C+USA&s=4YErw5vV5ZfzEX`)
})
...
test('article-universe-related-button', async (t) => {
    ...
    await t.expect(getLocation())
        .eql(`${TARGET}/article.html?longname=Los+Angeles+County%2C+California%2C+USA&universe=California%2C+USA&s=4YErw5vV5ZfzEX`)
})
...
test('article-universe-search', async (t) => {
    ...
    await t
        .pressKey('enter')
    await t.expect(getLocation())
        .eql(`${TARGET}/article.html?longname=Chino+city%2C+California%2C+USA&universe=California%2C+USA&s=4YErw5vV5ZfzEX`)
})
...
test('article-universe-compare', async (t) => {
    ...
    await t.expect(getLocation())
        .eql(
            `${TARGET}/comparison.html?longnames=%5B%22San+Marino+city%2C+California%2C+USA%22%2C%22San+Francisco+city%2C+California%2C+USA%22%5D&universe=California%2C+USA&s=4YErw5vV5ZfzEX`,
        )
    await screencap(t)
})
...
test('article-universe-compare-different', async (t) => {
    ...
    await t.expect(getLocation())
        .eql(
            `${TARGET}/comparison.html?longnames=%5B%22San+Marino+city%2C+California%2C+USA%22%2C%22Chicago+city%2C+Illinois%2C+USA%22%5D&s=4YErw5vV5ZfzEX`,
        )
    await screencap(t)
})
...
test('article-universe-state-world', async (t) => {
    ...
    await t.expect(getLocation())
        .eql(`${TARGET}/article.html?longname=California%2C+USA&s=4YErw5vV5ZfzEX&universe=world`)
    // screenshot
    await screencap(t)
})
...
test('article-universe-state-from-subnational', async (t) => {
    ...
    await t
        .click(Selector('a').withText('>'))
    await t.expect(getLocation())
        .eql(`${TARGET}/article.html?longname=California%2C+USA&universe=world&s=4YErw5vV5ZfzEX`)
    await screencap(t)
})
