...
errorInSubfield(() => test)('semantic-min-center', 'linearScale(min=10, center=10)', 'Error while executing function: Error: Inconsistent parameters: center 10 must be strictly greater than min 10')
errorInSubfield(() => test)('semantic-max-center', 'linearScale(max=5, center=5)', 'Error while executing function: Error: Inconsistent parameters: center 5 must be strictly less than max 5')
