...
const urls = {
    ...
    'translucencyRamp': '/mapper.html?settings=H4sIAAAAAAAAA3VOS0vEMBD%2BKyGnBHLYXis5uPUmKrh4sh6maewG00zIY0VK%2F7vJdosnwxBmvvkes9BJ4xTAn38ejRtpS7vugQqanbnoEHUFwJpPDM6AIG%2Bn%2B7KMKhifaLvQHGNhqBwTzs84atbTnvK73il0o0kGHWEpZM0L8gSe9Y6UN0IC6dFnC5UiNjQqsFpa4zSEU%2B0Zv20CzF4Wx1isVHotE3tfLmCzbslBEIUWQ0vCNLBGVKAUyANfBdlZzX%2Bshq8fe8wAUc%2FgpcPj1rEB1NcUMLuxq2p5E29VI3Yp5lQP%2FzvyZQPYNVVe%2F6MtboJ8azOdUwnuHafr%2BgsUPXOtgQEAAA%3D%3D',
    'translucentRamp': '/mapper.html?settings=H4sIAAAAAAAAA4WSXWvDIBSG%2F4p4ZUBKkuajzfBi7eXYBiu7WkaxRlJposGPllL632eSrrDANhGVc87znqPHC6y5qjXt9ucnIStYwLVy0p4hhk6KI9eGDzYpObOCOYvB%2B%2BbRew3TorOwuEBnjA9hzljVvqiKoxKWMHgoJVOyElYoCZDVjgfe8kw7VErgR0UtJRWXRtjztjtto0OLR49htOGkEZJTvenPKLh5NG078iORT2G8NrNv3oU%2ByjHucqSN4wUIMWCqUboAut6hcJYuYwzC2Tyd91uepRhQ4s3BFU%2FJWZxO4BuVLP9np2gY5z2UJeO2yP5g8ymcJtE9462KX%2BBoQubxcN1sPpQcLZI76cHPwDfp9q47anhLOyLVajyhHWWHWvufUK17RdILevlxepHgG1XO9p0i90a8jgY0VEKGddV4NQxOXNR7SyL%2FDwJ4vX4BmQRSIXoCAAA%3D',
}
...
regressionTest(() => test, 'translucencyRamp', `cMap(
    data=population,
    scale=linearScale(),
    ramp=constructRamp([{value: 0, color: rgb(1, 0, 0, a=0)}, {value: 1, color: rgb(1, 0, 0, a=1)}]),
    basemap=noBasemap(backgroundColor=rgb(1, 1, 1, a=0)),
    outline=constructOutline(color=colorBlack, weight=1)
)
`)

regressionTest(() => test, 'translucentRamp', `cMap(
    data=density_pw_1km,
    scale=linearScale(),
    ramp=constructRamp([
    {value: 0, color: rgb(0.592, 0.353, 0.765, a=0.5)},
    {value: 0.25, color: rgb(0.353, 0.49, 0.765, a=0.5)},
    {value: 0.5, color: rgb(0.027, 0.647, 0.686, a=0.5)},
    {value: 0.75, color: rgb(0.541, 0.765, 0.353, a=0.5)},
    {value: 1, color: rgb(0.722, 0.639, 0.184, a=0.5)}
]),
    basemap=noBasemap(backgroundColor=rgb(1, 1, 1, a=0)),
    outline=constructOutline(color=colorBlack, weight=1)
)
