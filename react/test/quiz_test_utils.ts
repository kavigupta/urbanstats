...
export function quizFixture(fixName: string, url: string, newLocalstorage: Partial<Record<LocalStorageKey, string>>, sqlStatements: string, platform: 'desktop' | 'mobile'): void {
