...
import { parse_time_identifier, History } from './statistics';
...
export function AudienceStatistics({ total, per_question } : { total: number, per_question: number[] }) {
...
export function DisplayedStats({ statistics }: { statistics: { value: string, name: string, addtl_class?: string }[]}) {
...
export function DisplayedStat({ number, name, addtl_class }: { number: string, name: string, addtl_class?: string }) {
