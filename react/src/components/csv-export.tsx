 ...
 * than from what the table is showing. So the caller doesn't have to hold them for the
 * export's sake, and edit mode -- which shows every statistic regardless of the selection --
 * still exports only the selected ones.
 */
