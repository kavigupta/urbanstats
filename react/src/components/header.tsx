...
export function Header(props: {
    ...
    on_universe_update: (new_universe: string) => void,
}) {
        ...
        <div className="top_panel">
            ...
            <div className="right_panel_top" style={{ height: HEADER_BAR_SIZE }}>
                ...
                <div style={{ display: "flex", flexDirection: "row", height: "100%" }}>
                    {!responsive.mobileLayout && props.hasUniverseSelector
                    ...
                    <div style={{ flexGrow: 1 }}>
                        <SearchBox
                            on_change={
                                new_location => { window.location.href = article_link(props.current_universe, new_location) }
                            }
...
function TopLeft(props: {
    hamburger_open: boolean, set_hamburger_open: (newValue: boolean) => void,
...
function UniverseSelector(props: { current_universe: string, all_universes: string[], on_universe_update: (new_universe: string) => void}) {
    ...
    var dropdown = dropdown_open ? <UniverseDropdown
        ...
        on_universe_update={(universe: string) => {
            ...
            props.on_universe_update(universe);
        }} /> : undefined;
    ...
    return (
        <div style={{ marginBlockEnd: "0em", position: "relative", width: width }}>
            <div style={
                ...
                <img src={`/icons/flags/${props.current_universe}.png`} alt={props.current_universe} width={width}
...
function UniverseDropdown(props: { all_universes: string[], on_universe_update: (new_universe: string) => void, flag_size: number }) {
    return (
        <div>
            ...
            {props.all_universes.map((universe: string) => {
                return (
