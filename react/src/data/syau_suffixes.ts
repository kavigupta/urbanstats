const value: string[] = [
    ...
    "hamilton county",
    "in hamilton county",
    "do norte metropolitan cluster",
    "fulton county",
    "in fulton county",
    "vista metropolitan cluster",
    "nagar",
