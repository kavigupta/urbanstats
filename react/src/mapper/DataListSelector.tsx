...
export function DataListSelector<T extends string>({ overall_name, initial_value, names, onChange, no_neutral, header_style }: { overall_name: string | undefined, initial_value: T | undefined, names: readonly T[], onChange: (newValue: T) => void, no_neutral?: boolean, header_style?: React.CSSProperties }): ReactNode {
