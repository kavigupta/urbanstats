...
function RegressionSelector(props: { regression: RegressionDescriptor, set_regression: (newValue: RegressionDescriptor) => void, delete_regression: () => void, names: string[] }) {
    ...
    const lhs = <StatisticSelector
        ...
        overall_name={undefined}
        set_statistic={stat => props.set_regression({
            ...props.regression,
            independent: stat,
        })}
        names={props.names}
    ...
    const main = <div style={{ display: "flex" }}>
        ...
        <div style={{ width: "70%" }}>
            ...
            <CheckboxSettingCustom
                ...
                set_setting={
                    (key, value) => props.set_regression({
                        ...props.regression,
                        [key]: value,
                    })
                }
...
function FunctionSelector(props: { function: ColorStatDescriptor, set_function: (newValue: ColorStatDescriptor) => void, names: string[], simple?: boolean, no_name_field?: boolean, placeholder?: string }) {
    ...
    return (
        <div style={{ paddingLeft: "1em" }}>
            ...
            <VariablesSelector
                ...
                set_variables={variables => props.set_function({
                    ...func,
                    variables: variables || [],
                })}
                names={props.names}
            ...
            <RegressionsSelector
                ...
                set_regressions={regressions => props.set_function({
                    ...func,
...
function VariablesSelector({ get_variables, set_variables, names }
    : { get_variables: () => VariableDescriptor[], set_variables: (newValue: VariableDescriptor[]) => void, names: string[] }
) {
    return <>
        {
...
function RegressionsSelector({ get_regressions, set_regressions, names }: { get_regressions: () => RegressionDescriptor[], set_regressions: (newValue: RegressionDescriptor[]) => void, names: string[] }) {
...
function FilterSelector(props: { filter: FilterSettings, set_filter: (newValue: FilterSettings) => void, names: string[] }) {
        ...
        <div>
            ...
            </span>
            {
                filter.enabled ? <FunctionSelector
                    ...
                    set_function={f => props.set_filter({
                        ...filter,
                        function: f,
                    })}
                    names={props.names}
...
export function StatisticSelector({ statistic, set_statistic, names, overall_name, simple }: { statistic: ColorStatDescriptor | undefined, set_statistic: (newValue: ColorStatDescriptor) => void, names: string[], overall_name: string | undefined, simple: boolean }) {
