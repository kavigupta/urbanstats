...
export function executeAsync(request: { descriptor: { kind: 'mapper', geographies: GeographySelection[] }, stmts: UrbanStatsASTStatement }): Promise<USSExecutionResult<{ type: USSOpaqueType, value: USSOpaqueValue & { opaqueType: 'cMap' | 'cMapRGB' | 'pMap' | 'clusterMap' | 'plot' } }>>
