...
function mergeValuesViaMasksSpecialCaseMap(
    ...
    if (nonNullValue.type.type !== 'opaque' || (nonNullValue.type.name !== 'cMap' && nonNullValue.type.name !== 'cMapRGB' && nonNullValue.type.name !== 'pMap' && nonNullValue.type.name !== 'clusterMap' && nonNullValue.type.name !== 'table')) {
