...
function computeCommonMap(
    ...
    // only the unit the script stated. Where it states none, whoever draws the map works one out
    // from the script itself, which handles expressions that no single statistic's unit describes
