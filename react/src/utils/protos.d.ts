...
export interface ISearchIndex {
    ...
    /** SearchIndex entries */
    entries?: (SearchIndex.IEntry[]|null);

    /** SearchIndex lengthOfLongestToken */
    lengthOfLongestToken?: (number|null);
...
export class SearchIndex implements ISearchIndex {
    ...
    /** SearchIndex entries. */
    public entries: SearchIndex.IEntry[];

    /** SearchIndex lengthOfLongestToken. */
    public lengthOfLongestToken: number;
...
export namespace SearchIndex {
    ...
    interface IHaystack {
        ...
        /** Haystack signature */
        signature?: (number|Long|null);
    }

    /** Represents a Haystack. */
    class Haystack implements IHaystack {

        /**
         * Constructs a new Haystack.
         * @param [properties] Properties to set
         */
        constructor(properties?: SearchIndex.IHaystack);
         ...
         * @param [properties] Properties to set
         * @returns Haystack instance
         */
        public static create(properties?: SearchIndex.IHaystack): SearchIndex.Haystack;

        /**
         * Encodes the specified Haystack message. Does not implicitly {@link SearchIndex.Haystack.verify|verify} messages.
         * @param message Haystack message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: SearchIndex.IHaystack, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: SearchIndex.IHaystack, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): SearchIndex.Haystack;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): SearchIndex.Haystack;
         ...
         * @returns Haystack
         */
        public static fromObject(object: { [k: string]: any }): SearchIndex.Haystack;

        /**
         * Creates a plain object from a Haystack message. Also converts values to other types if specified.
         * @param message Haystack
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: SearchIndex.Haystack, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    class Entry implements IEntry {
         ...
         * @param [properties] Properties to set
         */
        constructor(properties?: SearchIndex.IEntry);
         ...
         */
        public static create(properties?: SearchIndex.IEntry): SearchIndex.Entry;
         ...
         * @returns Writer
         */
        public static encode(message: SearchIndex.IEntry, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: SearchIndex.IEntry, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): SearchIndex.Entry;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): SearchIndex.Entry;
         ...
         * @returns Entry
         */
        public static fromObject(object: { [k: string]: any }): SearchIndex.Entry;
         ...
         * @returns Plain object
         */
        public static toObject(message: SearchIndex.Entry, options?: $protobuf.IConversionOptions): { [k: string]: any };
