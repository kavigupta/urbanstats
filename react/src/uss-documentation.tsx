        ...
        <Header key={props.name} title={props.name} header="h4" ident={props.name} docQuery={props.value.documentation!.category}>
            <div style={{ marginBottom: '20px', marginLeft: '20px' }}>
                ...
                <div style={{ marginBottom: '10px' }}>
                    {reifyReact(props.value.documentation?.longDescription ?? 'No description available.', readerSettings)}
                </div>
    ...
    const cells = props.tableConstants.map(([name, value]) => ({
        ...
        row: [
            ...
            <span key="description">
                {reifyReact(value.documentation?.longDescription ?? 'No description available.', readerSettings)}
