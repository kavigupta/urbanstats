...
export default tseslint.config(
    ...
    {
        ignores: ['**/*.{js,cjs,mjs}', 'src/utils/protos.d.ts', 'src/utils/urbanstats-persistent-data.d.ts', 'src/utils/google-drive.d.ts', 'src/data/**', 'cf-og-worker/.wrangler/**', 'totp-worker/.wrangler/**'],
    },
    {
        rules: {
